                    ...
                    <form action="<?= base_url('data-arsip/save') ?>" method="post" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <div class="col-md-12">
                                    <input type="hidden" class="form-control" name="bulan" value="<?= format_bulan(date('Y-m-d')); ?>">
                                    <input type="hidden" class="form-control" name="tahun" value="<?= format_tahun(date('Y-m-d')); ?>">
